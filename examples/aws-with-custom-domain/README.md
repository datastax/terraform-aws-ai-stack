...
### 2.5 - Setting up a Route53 public hosted zone

- ✅ `2.5.a` - Visit the AWS console to create a public hosted zone for your apex domain (e.g. `aws.enterprise-ai-stack.com`).
...
```sh
cd terraform-aws-astra-ai-stack/examples/aws-with-custom-domain
```
